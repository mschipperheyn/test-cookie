...
import sessionSecurity, { authenticationMiddleware } from './middleware/passport';
...
// Put this before sessionSecurity to avoid statics getting cookies applied
app.use(
...
// setup db and passport
connect();

// hook up the REST routes to express
routes(app);
...
app.get('/admin/logout', reactApplication);
app.get('/admin*', authenticationMiddleware, reactApplication);
