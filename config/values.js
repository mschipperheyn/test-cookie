...
const values = {
  ...
  server: {
    ...
    sendEmail: process.env.NODE_ENV === 'production' || false,
  },
  uploads: {
    path: process.env.UPLOAD_PATH,
    s3: {
      clientId: process.env.AWS_KEY,
      clientSecret: process.env.AWS_SECRET,
      bucket: 'client',
      zone: 'sa-east-1',
      folder: '',
    },
  ...
  google: {
    ...
    development: {
      callbackURL: 'https://www.client.com.br/auth/google/callback',
    },
    production: {
      callbackURL: 'https://www.client.com.br/auth/google/callback',
    },
  ...
  facebook: {
    ...
    development: {
      callbackURL: 'https://www.client.com.br/auth/facebook/callback',
    },
    production: {
      callbackURL: 'https://www.client.com.br/auth/facebook/callback',
    },
  ...
  analytics: {
    key: 'UA-12345-2',
    active: process.env.NODE_ENV === 'production' || false,
  },
  mail: {
    /*
    config: {
    ...
    defaultFrom: process.env.MAIL_DEFAULTFROM,
    defaultTo: process.env.MAIL_DEFAULTTO,
    config: {
      auth: {
        apiKey: process.env.MANDRILL_SECRET,
      },
    } /* {
      ...
      SES: new aws.SES({
        ...
        AWSAccessKeyID: process.env.MAIL_USER,
        AWSSecretKey: process.env.MAIL_PASS,
        SeviceUrl: 'email-smtp.us-east-1.amazonaws.com',
      }),
    }, */,
  },
  ...
  welcomeMessage: EnvVars.string('WELCOME_MSG', 'Hello!'),
  ...
  htmlPage: {
    titleTemplate: 'Client - %s',
    defaultTitle: 'Title',
    description: 'description',
    keywords: 'keywords',
    shareImage: 'https://www.client.com.br/img/facebook-share4.jpg',
    shareImageWidth: 1203,
    shareImageHeight: 630,
    url: 'https://www.client.com.br',
    googleVerify: '',
  },
  ...
  cspExtensions: {
    ...
    styleSrc: [
      ...
      'cdnjs.cloudflare.com/ajax/libs/flexboxgrid/6.3.1/flexboxgrid.css',
