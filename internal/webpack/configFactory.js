...
export default function webpackConfigFactory(buildOptions) {
  ...
  // flexboxgrid cannot deal with hashed class names
  ...
  let webpackConfig = {
    ...
    resolve: merge(
      ...
      },
      {
        ...
        /* plugins: [componentResolver('existing-directory', 'undescribed-raw-file')], */
      },
    ...
    plugins: removeNil([
      ...
      ifProdClient(
        () =>
          // We put this here so we can compress sw.js and related html also
          // It does assume serviceworker enabled, otherwise, we would have to include it conditionally in the main config
            ...
            query: config('plugins.babelConfig')(
              // Our "standard" babel config.
              {
                ...
                plugins: [
                  ...
                  ifProd('transform-remove-strict-mode'),
